    ...
    <BrowserRouter>
      <UserProvider> 
        <Routes>
          ...
          <Route path="/api/salary/set" element={<Dashboard role="admin"><SetSalary/></Dashboard>} />
          ...
          <Route path="/api/salary/view" element={<Dashboard role="visitor"><ViewSalary/></Dashboard>} />
        </Routes>
       </UserProvider> 
    </BrowserRouter>
  );
